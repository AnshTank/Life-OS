...
export type PartnerNoteType = 'general' | 'meeting' | 'call' | 'email' | 'follow-up';
...
export interface ProjectTask {
  ...
  completedAt?: Date;
  assignees?: string[];
  assignee?: string; // legacy single-assignee compat
  priority?: 'low' | 'medium' | 'high' | 'urgent';
  dueDate?: Date;
}

export type TimeLogCategory = 'development' | 'client-call' | 'meeting' | 'design' | 'testing' | 'review' | 'planning' | 'other';
